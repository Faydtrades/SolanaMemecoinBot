...
from .paper_continuous_firstpullback_binding_v0_2 import (
    MODEL_FINGERPRINT as BINDING_V02_FINGERPRINT,
...
MODEL_ID = "P4-CONTINUOUS-FIRSTPULLBACK-BINDING-0003"
SCHEMA_VERSION = "phase4_continuous_firstpullback_binding_v0.3"
SPEC = {
    "model_id": MODEL_ID,
    "schema_version": SCHEMA_VERSION,
    "accepted_binding_v0_2_fingerprint": BINDING_V02_FINGERPRINT,
...
class ContinuousFirstPullbackBindingV03(ContinuousFirstPullbackBindingV02):
    """V02 paper semantics bound to the incremental Market Source V02."""
    ...
    def _bind_runtime_v03(self) -> None:
        ...
        if actual != expected:
            raise BindingConflict(
                f"persisted v0.3 binding identity conflict: actual={actual!r} expected={expected!r}"
            )
