...
SCHEMA_VERSION = "phase4_live_observability_binding_v0.2"
ENGINE_VERSION = "PaperLiveObservabilityBindingV02"
MODEL_ID = "P4-LIVE-OBSERVABILITY-BINDING-0002"
...
def _primitive(value: Any) -> Any:
    ...
    if isinstance(value, Decimal):
        ...
        # Audit snapshots are persisted as canonical JSON. Decimal -> exact
        # base-10 text preserves the Phase-2 value without a float round-trip.
        return str(value)
