...
from .outcome_replay_v0_1_1 import CoverageInterval, CoverageStatus, IntervalCoverageProvider
...
class CollectorCoverageSnapshotV01:
    path: Path
    payload: Mapping[str, Any]

    @classmethod
    def load(cls, path: str | Path) -> "CollectorCoverageSnapshotV01":
        p = Path(path)
