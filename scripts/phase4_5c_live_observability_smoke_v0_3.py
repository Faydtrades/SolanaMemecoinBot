...
NS2 = "tradingbot_local_phase2_p4_5c_v02"
NS4 = "tradingbot_local_phase4_p4_5c_v02"
...
LOCKED_LIVE_OBS_BINDING_ID = "P4-LIVE-OBSERVABILITY-BINDING-0002"
...
def main() -> int:
    ...
    live_obs_mod = local_import(NS4, PHASE4_ROOT, "paper_live_observability_binding_v0_2")
    ...
    print("=" * 124)
    print("PHASE 4.5C - CONTROLLED LIVE ENTRY -> EXIT + RUNTIME OBSERVABILITY SMOKE v0.3")
    print("=" * 124)
                        ...
                        if entry_active is not None:
                            ...
                            if (
                                ...
                                if route_state == "FILLED":
                                    ...
                                    # IMPORTANT: create and validate the complete exit-execution
                                    # schema BEFORE the first post-entry equity mark.
                                    # PaperTradeAccounting validates the exact exit schema even
                                    # when there are zero completed exits, so recording equity
                                    # before executor initialization is a deterministic ordering
                                    # error on a fresh live paper DB.
                                    ...
                                    accounting_mod.validate_source_schema(paper_conn)
                                    refs = exit_bridge.bind_signal(signal_key)
    ...
    audit_payload = {
        "schema_version": "phase4_5c_live_observability_smoke_v0.3",
