...
SCHEMA_VERSION = "pump_scoped_event_v0.2"
...
def raw_file_path() -> Path:
    ...
    return RAW_DIR / f"pump_scoped_events_{date_part}.jsonl"
...
async def run_listener(max_events: int | None) -> None:
    ...
    print("=" * 82)
    print("SOLANA MEMECOIN BOT - PUMP MARKET LISTENER v0.2 (PROGRAM-SCOPED)")
    print("=" * 82)
