...
from phase3.locked_entry_readiness_v0_1_1 import parameter_set_from_locked_row
T=datetime(2026,8,21,12,0,0,tzinfo=timezone.utc)
def check(c,l):
    if not c:raise AssertionError(l)
    print(f"[PASS] {l}")
def main():
    print("EXP-0007 LOCKED-ENTRY READINESS INTEGRATION SELFTEST v0.1.1");print("="*72)
