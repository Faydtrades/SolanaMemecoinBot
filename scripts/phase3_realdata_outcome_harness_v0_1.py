...
from phase3.outcome_replay_v0_1_1 import HorizonStatus, OutcomeReplayV011
from phase3.phase2_outcome_adapter_v0_1 import (
    extract_candidates,
...
def main() -> None:
    ...
    replay = OutcomeReplayV011(coverage.provider())
    outcomes = [
    ...
    report_core = {
        "schema_version": "P3-3.1-REALDATA-0.1",
        ...
        "versions": {
            ...
            "outcome_replay": "phase3_outcome_replay_v0.1.1",
            "coverage": "P3COV-0.1",
        },
        "foundation_probe": {
    ...
    exp_manifest = {
        ...
        "experiment_id": "EXP-0001",
        "status": "COMPLETE_PHASE3_1_FOUNDATION",
        "hypothesis": (
    ...
    report_path = out_dir / "phase3_1_outcome_replay_report_v0_1.json"
    manifest_out = out_dir / "EXP-0001_manifest_v0_1.json"
    csv_path = out_dir / "phase3_1_candidate_outcomes_v0_1.csv"
    ...
    print("PHASE 3.1 REAL-DATA OUTCOME HARNESS v0.1")
    print("=" * 54)
