...
from phase3.outcome_replay_v0_1_1 import (
    CandidateReference,
...
def run():
    print("PHASE 3.1 OUTCOME REPLAY SELFTEST v0.1.1")
    print("=" * 48)

    complete = ConstantCoverageProvider(CoverageStatus.COMPLETE)
    engine = OutcomeReplayV011(complete)
    ...
    gap_out = OutcomeReplayV011(gap_provider).replay(cand(), [obs(4_500, 1, 120)])
    ...
    partial = OutcomeReplayV011(partial_provider).replay(cand(), [obs(2_000, 1, 110)])
