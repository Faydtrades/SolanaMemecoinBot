...
def phase2_runtime_probe() -> None:
    models = importlib.import_module("phase2.models_v0_1")
    feature_mod = importlib.import_module("phase2.feature_engine_v0_2")
    strategy_mod = importlib.import_module("phase2.strategy_first_pullback_v0_2")
    adapter_mod = importlib.import_module("phase2.phase1_readonly_adapter_v0_1")
    clock_mod = importlib.import_module("phase2.strategy_clock_v0_1")
    quote_mod = importlib.import_module("phase2.quote_aware_price_v0_1")
    flow_mod = importlib.import_module("phase2.denomination_aware_flow_v0_1")
...
def main() -> int:
    print("=" * 118)
    print("PHASE 4.3B1A - EXACT RUNTIME BINDING PROBE v0.2")
    print("=" * 118)
    print(f"Project root                       : {PROJECT_ROOT}")
    print(f"Source root                        : {SRC_ROOT}")
    print(f"Production DB                      : {PRODUCTION_DB}")
    print("Production DB mode                 : QUERY-ONLY / READ-ONLY")
    print("Import layout                      : src\\ added to sys.path; modules imported as phase2.*")
