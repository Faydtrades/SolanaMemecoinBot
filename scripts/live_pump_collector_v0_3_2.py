...
def raw_file_path() -> Path:
    ...
    return RAW_DIR / f"live_pump_notifications_v0_3_2_{day}.jsonl"


def log_file_path() -> Path:
    LOG_DIR.mkdir(parents=True, exist_ok=True)
    day = datetime.now(timezone.utc).strftime("%Y%m%d")
    return LOG_DIR / f"live_collector_v0_3_2_{day}.log"
            ...
            async with connect(
                ...
                while not listener_stop.is_set():
                    ...
                    append_jsonl(
                        raw_path,
                        {
                            "schema_version": "live_pump_notification_v0.3.2",
...
async def run(
    ...
    print("=" * 104)
    print("SOLANA MEMECOIN BOT - ROBUST LIVE COLLECTOR v0.3.2")
    print("=" * 104)
