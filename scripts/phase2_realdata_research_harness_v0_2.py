...
from src.phase2.research_replay_v0_2 import (
...
DEFAULT_OUT_DIR = ROOT / "data" / "research" / "phase2_research_v0_2"
...
def main(db_path: Path, out_dir: Path, token_limit: int) -> None:
    print("PHASE 2 REAL-DATA RESEARCH / REPLAY HARNESS v0.2")
    ...
    json_path = out_dir / "phase2_research_replay_v0_2.json"
    csv_path = out_dir / "phase2_research_token_metrics_v0_2.csv"
    manifest_path = out_dir / "phase2_research_manifest_v0_2.json"

    json_path.write_text(json.dumps(payload, indent=2, sort_keys=True, default=str), encoding="utf-8")
    write_token_csv(csv_path, token_rows)
    manifest = {
        "schema_version": "P2RR-MANIFEST-0.2",
