"""V2 hot supplement: original resource-held or pending-recovery child boundary.
...
def measure(origin,output,repetitions):
    ...
    for n in range(repetitions):
        ...
        resource_copy=root/'host-resources.json'
        shutil.copyfile(origin/'host-resources.json',resource_copy)
