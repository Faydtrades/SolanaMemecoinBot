...
DEFAULT_OUT = PROJECT_ROOT / "data" / "research" / "phase2_data_coverage_root_cause_v0_1_1"
...
def main(db_path: Path, out_dir: Path) -> None:
    print("PHASE 2 DATA COVERAGE / UNPRICEABLE TOKEN ROOT-CAUSE AUDIT v0.1.1")
    ...
    try:
        ...
        report_path = out_dir / "phase2_data_coverage_root_cause_report_v0_1_1.json"
        token_path = out_dir / "phase2_unpriceable_tokens_v0_1_1.csv"
        event_path = out_dir / "phase2_unpriceable_events_v0_1_1.csv"
        sessions_path = out_dir / "phase2_collector_sessions_v0_1_1.csv"
        bins_path = out_dir / "phase2_collector_coverage_30m_v0_1_1.csv"
